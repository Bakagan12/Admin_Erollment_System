...
import { PassCodeComponent } from './views/site/forgot-password/pass-code/pass-code.component';

export const routes: Routes = [

  //Home Page
  { path: '', redirectTo: 'homepage', pathMatch: 'full' },
  { path: 'homepage', component: LandingPageComponent, canActivate: [NoAuthGuard] },
  ...
  { path: 'forgot/password/pass_code', component: PassCodeComponent, canActivate: [NoAuthGuard] },
  { path: 'change_password', component: ChangePasswordComponent, canActivate: [NoAuthGuard] },
