    ...
    const { person_id, guardian_id, username, password, gen_user_email, user_role_id, status_id, is_emailed, is_deleted, is_deleted_by }: { person_id:number; guardian_id:number, username: string; gen_user_email:string, password: string, user_role_id:number, status_id:number, is_emailed:boolean, is_deleted:number, is_deleted_by:number} = req.body;

    try {
        const result = await userService.createUser(person_id, guardian_id, username,gen_user_email, password, user_role_id, status_id, is_emailed, is_deleted, is_deleted_by);
